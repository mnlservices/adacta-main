...
/**
 * This class encapsulates the {@link org.alfresco.repo.lock.JobLockService JobLockService} usage in order to guarantee that a job is not executed simultaneously in more than one
 * node in a cluster. After instantiated passing in constructor {@link org.alfresco.schedule.AbstractScheduledLockedJob job} to be executed, as well as the name of the to be locked
 * job and the {@link org.alfresco.repo.lock.JobLockService JobLockService}, the execute method of this class will execute the job taking care of all cluster aware lockings.
 * <p/>
 * This code is based on original code by Derek Hulley on {@link org.alfresco.repo.content.cleanup.ContentStoreCleaner ContentStoreCleaner}, extracting the generic locking code in
 * order to be reused and avoid code duplication.
 * 
 * @author Rui Fernandes
 * @since 4.1.5
 */
public class ScheduledJobLockExecuter {
	/** If the lock-time-to-live value has passed, the lock is automatically released. Therefore the value is set to a high value (15 minutes) */
	private static final long LOCK_TTL = 900000;
