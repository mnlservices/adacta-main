   ...
   "data":
   {
      ...
      [
         <#list items as item>
         {
            ...
            "owner": "<#if item.owner??>${item.owner}</#if>",
            "ownerFullName": "<#if item.ownerFullName??>${item.ownerFullName}</#if>",
            ...
            "scanEmployeeFullName": "<#if item.scanEmployeeFullName??>${item.scanEmployeeFullName}</#if>",
