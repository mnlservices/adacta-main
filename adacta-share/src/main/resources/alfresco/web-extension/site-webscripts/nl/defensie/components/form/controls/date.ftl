...
<div class="form-field">
   <#if form.mode == "view">
      <div class="viewmode-field">
         ...
         <#elseif !multiValued>
            <#-- If you not comment this out, setting form.control.date-picker.view.date.format will not work. Probably a bug?? -->
   ...
   <#elseif !multiValued>
      ...
      <#else>
         ...
         <input id="${fieldHtmlId}" class="date-entry" type="hidden" name="${field.name?html}" value="${field.value?html}" />
         ...
         <#if disabled == false>
            <a id="${controlId}-icon" tabindex="1" href="#"><img src="${url.context}/res/components/form/images/calendar.png" class="datepicker-icon"/></a>
         </#if>
