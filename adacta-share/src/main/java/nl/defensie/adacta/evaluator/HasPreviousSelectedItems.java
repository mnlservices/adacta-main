...
public class HasPreviousSelectedItems extends BaseEvaluator {

	// private static Log LOGGER = LogFactory.getLog(HasPreviousSelectedItems.class);

	private static final String LINK = "/nl/defensie/adacta/preferences/selected-items/prev/";
